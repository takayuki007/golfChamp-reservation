        ...
        <div class="c-form">
            <form method="post" action="{{ route('reservation.store') }}">
                ...
                <div class="c-form-group">
                    ...
                    <div class="c-input-area">
                        <select name="time_id" class="c-input @error('time') c-is-invalid @enderror" value="{{ old('time') }}">
                ...
                <div class="c-form-group">
                    ...
                    <div class="c-input-area">
                        <select name="coach_id" class="c-input @error('coach') c-is-invalid @enderror" value="{{ old('coach') }}">
                ...
                <div class="c-form-group">
                    ...
                    <div class="c-input-area">
                        <select name="location_id" class="c-input @error('location') c-is-invalid @enderror" value="{{ old('location') }}">
                            <option value="">選択してください</option>
